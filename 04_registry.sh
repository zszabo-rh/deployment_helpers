...
cp /opt/registry/certs/domain.crt ./tls-ca-bundle.pem
...
oc adm release extract -a ./pull_secret.json --command=openshift-install "${REGISTRY_HOSTNAME}:${REG_PORT}/ocp4/openshift4:${OCP_VER}-x86_64"
